/**
 * Provides a UI when the 'Table Manager' option 
 * is selected from the 'Main Menu'.
 */
public class TableUI {

	/**
	 * Displays the options under the 'Order Manager' option, 
	 * namely to find an available table for a group, 
	 * list occupied tables, 
	 * list reserved tables, 
	 * list available (in other words, unoccupied) tables, 
	 * and list all tables.
	 * 
	 * @param tables Table manager
	 * @param reservations Reservation manager
	 */
	...
	/**
	 * Finds an available table for a specified number of people in a group.
	 * 
	 * @param tables Table manager
	 */
