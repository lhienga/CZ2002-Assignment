/**
 * Provides a UI when the 'Staff Manager' option 
 * is selected from the 'Main Menu'.
 */
public class StaffUI {
    
	/**
	 * Displays the options under the 'Staff Manager' option, 
	 * namely to add a staff, 
	 * remove a staff, 
	 * print details of a staff, 
	 * print details of all staffs, 
	 * and update details of a staff.
	 * 
