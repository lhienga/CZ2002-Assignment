...
/**
 * Provides a UI when the 'Menu Manager' option 
 * is selected from the 'Main Menu'.
 */
public class FoodMenuUI {

    /**
     * Displays the options under the 'Menu Manager' option, namely to print the menu, 
     * add an entry to the menu, remove an entry from the menu, 
     * and update an entry in the menu.
     * 
	...
	/**
	 * Provides a UI for adding an entry to the restaurant menu.
	 * 
	 * @param menu Restaurant menu
	 */
	...
	/**
	 * Provides a UI for removing an entry from the restaurant menu.
	 * 
	 * @param menu Restaurant menu
	 */
	...
	/**
	 * Provides a UI for updating an entry from the restaurant menu.
	 * 
	 * @param menu Restaurant menu
	 */
