...
/**
 * Provides a UI when the 'Order Manager' option 
...
public class OrderUI {
	 ...
	 * namely to create an order, 
	 * cancel an order and clear table, 
	...
	/**
	 * Cancels an active order and clears the table making this order.
	 * 
	 * @param orders Order manager
	 * @param reservations Reservation manager
	 * @param tables Table manager
